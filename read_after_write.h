...
// The "raw" structure contains the information that lives in the ptds and is used 
// during read_after_write operations
// The following "raw_" members are for the Read After Write (aka -raw) option
