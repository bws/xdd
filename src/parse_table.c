...
xdd_func_t  xdd_func[] = {
  ...
  The word 'when' should be replaced with the word: \n\
    ...
    {"nomemlock", "nomlock",
            ...
            0,0,0,0},
			0},
    {"nostrictordering", "nso",
            xddfunc_nostrictordering,     
            1,  
            "  -nostrictordering [target <target#>]\n",  
            {"    Will not enforce Strict Ordering on QThreads for all targets or a specified target\n", 
