...
xdd_func_t  xdd_func[] = {
  ...
  The word 'when' should be replaced with the word: \n\
    ...
    {"looseordering", "lo",
            ...
            {"    Will enforce for Loose Ordering of QThreads for all targets or a specified target. Default is Loose Ordering\n", 
             "    see also: -serialordering\n",
			0,0,0},
			0},
    {"maxall", "maxall",
            xddfunc_maxall,     
    ...
    {"serialordering", "so",
            ...
            {"    Will enforce Serial Ordering on QThreads for all targets or a specified target. Default is Loose Ordering\n", 
             "    see also: -looseordering\n",
			0,0,0},
			0},
    {"syncio", "sio",
            xddfunc_syncio,     
