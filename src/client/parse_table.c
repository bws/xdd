...
xdd_func_t  xdd_func[] = {
    ...
    {"endtoend", "e2e",
            xddfunc_endtoend,
            1,
            "  -endtoend [target #]  issource | isdestination | destination <hostname[:baseport#[,portcount]]> | port <#> | portcount <#> | protocol (ipv4|ipv6)\n",
  ...
  The word 'when' should be replaced with the word: \n\
    ...
    {"serialordering", "so",
            ...
            {"    Will enforce Serial Ordering on QThreads for all targets or a specified target. Default is No Ordering\n", 
