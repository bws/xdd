 ...
 */
int32_t
xnet_e2e_target_init(target_data_t *tdp) {
 ...
 */
int32_t
xnet_e2e_worker_init(worker_data_t *wdp) {
	target_data_t	*tdp;
	int status;
	in_addr_t addr;
 ...
 */
int32_t
xnet_e2e_src_init(worker_data_t *wdp) {
	target_data_t	*tdp;
 ...
 */
int32_t
xnet_e2e_setup_src_socket(worker_data_t *wdp) {
 ...
 */
int32_t
xnet_e2e_dest_init(worker_data_t *wdp) {
	target_data_t	*tdp;
	int  		status; // status of various function calls 
 ...
 */
int32_t
xnet_e2e_setup_dest_socket(worker_data_t *wdp) {
	int  	status;
	int 	type;
	char 	msg[256];
 ...
 */
void 
xnet_e2e_set_socket_opts(worker_data_t *wdp, int skt) {
	target_data_t	*tdp;
	int status;
 ...
 */
void 
xnet_e2e_prt_socket_opts(int skt) {
	int 		level = SOL_SOCKET;
	int 		sockbuf_sizs;
	int			sockbuf_sizr;
	int			reuse_addr;
 ...
 */
void
xnet_e2e_err(worker_data_t *wdp, char const *whence, char const *fmt, ...) {
#ifdef WIN32
	LPVOID lpMsgBuf;
