 ...
 */
int32_t
xnet_e2e_src_send(worker_data_t *wdp) {
	target_data_t		*tdp;
 ...
 */
int32_t
xnet_e2e_dest_connection(worker_data_t *wdp) {
 ...
 */
int32_t
xnet_e2e_dest_receive_header(worker_data_t *wdp) {
	target_data_t		*tdp;			// Pointer to the Target Data
	xint_e2e_t			*e2ep;			// Pointer to the E2E struct for this worker
	xdd_e2e_header_t	*e2ehp;			// Pointer to the E2E Header 
 ...
 */
int32_t
xnet_e2e_dest_receive_data(worker_data_t *wdp) {
	target_data_t		*tdp;			// Pointer to the Target Data
	xint_e2e_t			*e2ep;			// Pointer to the E2E struct for this worker
	xdd_e2e_header_t	*e2ehp;			// Pointer to the E2E Header 
	int					status;			// function call status
 ...
 */
int
xnet_e2e_dest_receive_error(worker_data_t *wdp) {
	target_data_t		*tdp;			// Pointer to the Target Data
	xint_e2e_t			*e2ep;			// Pointer to the E2E struct for this worker
...
int32_t
xnet_e2e_dest_receive(worker_data_t *wdp) {
	target_data_t		*tdp;			// Pointer to the Target Data
	xint_e2e_t			*e2ep;			// Pointer to the E2E struct for this worker
	xdd_e2e_header_t	*e2ehp;			// Pointer to the E2E Header 
 ...
 */
int32_t
xnet_e2e_eof_source_side(worker_data_t *wdp) {
	target_data_t		*tdp;
	xint_e2e_t			*e2ep;			// Pointer to the E2E struct for this worker
	xdd_e2e_header_t	*e2ehp;			// Pointer to the E2E Header 
