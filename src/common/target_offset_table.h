...
struct tot_entry {
    ...
    int32_t tot_wait_worker_thread_number;	// Number of the QThread that is waiting for this TOT entry to be posted
    int32_t tot_post_worker_thread_number;	// Number of the QThread that posted this TOT entry 
    int32_t tot_update_worker_thread_number;	// Number of the QThread that last updated this TOT Entry
};
