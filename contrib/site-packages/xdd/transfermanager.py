...
class TransferManager:
    ...
    def monitorFlows(self, monitorInterval):
        ...
        while completeCount < len(builders):
            ...
            for b in builders:
                ...
                if (completedByte == 0) or (byte < completedByte):
                    completedByte = byte
            self.showProgress(completedByte)
            monEnd = time.time()
        ...
        if 0 == failures:
            self.showProgress(self.currentFlowSize)
            print('')
    ...
    def startAndMonitorFlows(self, monitorInterval):
        ...
        if 0 == rc:
            ...
            # Create all symlinks
            for (rfile, link) in links:
                sink.buildSymlink(rfile, link)
    ...
    def showProgress(self, completedBytes):
