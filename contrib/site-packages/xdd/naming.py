...
class PosixNamingStrategy(NamingStrategy):
    ...
    A brief description of POSIX recursive file naming are as follows:
      ...
      Symbolic links are created in the destination directory.  Absolute
      paths are re-written for dest such that if possible, if the link
      targets contain part of the source path, it will be changed to the
      dest path.
    """
