...
#
XDD_DIR := /home/bws/sandbox/xdd
BUILD_DIR := /home/bws/sandbox/xdd
INSTALL_DIR := 
...
fullinstall:
	...
	$(INSTALL) -c -m 755 bin/xdd.$(OS) $(INSTALL_DIR)/bin
	$(INSTALL) -c -m 755 bin/xdd.$(OS) $(INSTALL_DIR)/bin/xdd
	$(INSTALL) -c -m 755 bin/timeserver.$(OS) $(INSTALL_DIR)/bin
	$(INSTALL) -c -m 755 bin/timeserver.$(OS) $(INSTALL_DIR)/bin/timeserver
	$(INSTALL) -c -m 755 bin/gettime.$(OS) $(INSTALL_DIR)/bin
	$(INSTALL) -c -m 755 bin/gettime.$(OS) $(INSTALL_DIR)/bin/gettime
	$(INSTALL) -c -m 755 bin/qipcrm $(INSTALL_DIR)/bin
	$(INSTALL) -c -m 755 contrib/xddcp $(INSTALL_DIR)/bin
