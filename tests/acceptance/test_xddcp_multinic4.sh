...
rm -rf $XDDTEST_SOURCE_MOUNT/test_xddcp_multinic4
ssh -q $XDDTEST_E2E_DEST "rm -rf $XDDTEST_DEST_MOUNT/test_xddcp_multinic4"
...
ssh -q $XDDTEST_E2E_DEST "mkdir -p $XDDTEST_DEST_MOUNT/test_xddcp_multinic4"
...
#
rc=1
$XDDTEST_XDDCP_EXE $xddcp_opts -r -a -n 99 $src_dir $DEST_DATA_NETWORK_1,$DEST_DATA_NETWORK_2,$DEST_DATA_NETWORK_3:$XDDTEST_DEST_MOUNT/test_xddcp_multinic4
rc=$?
