...
#
# Validate the retry flag with xddcp
#
...
#
$XDDTEST_XDD_EXE -target $source_file -op write -reqsize 4096 -mbytes 2048 -qd 4 -datapattern random >/dev/null
...
#
sleep 10
ssh $XDDTEST_E2E_DEST "killall xdd.Linux"
